...
namespace OOAD_Projekat.Data.Migrations
{
    ...
    [Migration("20210603001843_Tabela za pracenje historije pitanja koja je korisnik otvarao, na osnovu kojih ce se vrsiti preporuka novih pitanja")]
    partial class Tabelazapracenjehistorijepitanjakojajekorisnikotvaraonaosnovukojihcesevrsitipreporukanovihpitanja
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OOAD_Projekat.Models.QuestionAndAnwserModels.ViewedQuestionsHistory", b =>
                {
                    b.Property<int>("QuestionId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ViewedQuestionsHistory");
                });
            ...
            modelBuilder.Entity("OOAD_Projekat.Models.Statistics.SearchStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OOAD_Projekat.Models.QuestionAndAnwserModels.ViewedQuestionsHistory", b =>
                {
                    b.HasOne("OOAD_Projekat.Models.Question", "Question")
                        .WithMany("ViewedQuestionsHistory")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OOAD_Projekat.Models.Question", b =>
                {
                    ...
                    b.Navigation("ViewedQuestionsHistory");
                });
